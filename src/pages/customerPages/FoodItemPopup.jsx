...
const FoodItemPopup = ({ close }) => {
  return (
    <div className='z-50 absolute bg-brand-fore-dark/50 w-full h-full'>
      <div className='inset-0 m-4 md:mx-auto pb-8 rounded-xl md:max-w-3xl overflow-hidden'>
        ...
        <div className='flex justify-center bg-brand-fore-dark p-4'>
          <FoodItemCardMax
        ...
        <div className='bg-brand-fore-dark p-4 rounded-b-xl'>
